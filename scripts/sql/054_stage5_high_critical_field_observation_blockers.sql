-- ============================================================================
-- Phase 5D-2 / B1: direct Stage 5 blockers for high/critical field observations
--
-- This migration changes only the server-authoritative transition function.
-- It adds no tables, columns, policies, Storage changes, or data backfill.
-- The function reads project_engineering_live.payload under row lock and never
-- accepts observation severity, remediation state, or workflow facts from the
-- browser.
-- ============================================================================
...
COMMENT ON FUNCTION public.transition_project_engineering_stage(uuid, text) IS
  'Phase 5D-2 B1: server-authoritative workflow transition with direct high/critical field-observation blockers; clients.pipeline_stage remains business-only.';
