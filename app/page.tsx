    ...
    <div className="main-dashboard space-y-6 pb-8">
      ...
      <section className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_310px]">
        ...
        <aside className="space-y-6">
          <div className="main-dashboard-surface rounded-[1.35rem] border p-6"><p className="main-dashboard-eyebrow">QUICK ACCESS</p><h2 className="mt-1 text-xl font-bold text-[var(--erp-text)]">اختصارات العمل</h2><div className="mt-4 grid gap-2"><QuickLink href="/projects" label="المشاريع والاستشارات" /><QuickLink href="/clients" label="العملاء" /><QuickLink href="/design" label="مركز التصميم" /><QuickLink href="/me" label="ملفي وصلاحياتي" /></div></div>
