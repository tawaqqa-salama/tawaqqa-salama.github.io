...
const ar: Dict = {
  ...
  'common.search': 'بحث',
  'common.logout': 'خروج',
  'common.logoutConfirmTitle': 'تسجيل الخروج',
  'common.logoutConfirmBody': 'هل تريد تسجيل الخروج من النظام؟',
  ...
  'shell.toggleClientNavShow': 'إظهار قائمة صفحات العميل',
  'shell.toggleClientNavHide': 'إخفاء قائمة صفحات العميل',
  'shell.toggleClientNavShowAria': 'إظهار قائمة صفحات العميل',
  'shell.toggleClientNavHideAria': 'إخفاء قائمة صفحات العميل',
  'shell.clientNavOpen': 'قائمة صفحات العميل مفتوحة',
  'shell.clientNavHidden': 'قائمة صفحات العميل مخفية',
  'clientNav.default': 'صفحات العميل',
  'dateFilter.from': 'من تاريخ',
  'dateFilter.to': 'إلى تاريخ',
  'dateFilter.clear': 'مسح الفترة',
  'dateFilter.preset.today': 'اليوم',
  'dateFilter.preset.yesterday': 'أمس',
  'dateFilter.preset.week': 'الأسبوع الحالي',
  'dateFilter.preset.month': 'الشهر الحالي',
  'dateFilter.preset.year': 'السنة الحالية',
  'sales.dashboard.clients': 'العملاء في الفترة',
  'sales.dashboard.documents': 'المستندات في الفترة',
  'sales.dashboard.quotations': 'عروض الأسعار المعتمدة',
  'hr.dashboard.employees': 'إجمالي الموظفين',
  'hr.dashboard.active': 'الموظفون النشطون',
  'hr.dashboard.assignments': 'المشاريع المرتبطة',
  'procurement.dashboard.vendors': 'الموردون',
  'procurement.dashboard.orders': 'أوامر الشراء',
  'procurement.dashboard.rfqs': 'طلبات التسعير',
  'shell.stagesVisible': 'أقسام المشروع ظاهرة — اضغط القائمة لإخفائها',
  'shell.stagesHidden': 'أقسام المشروع مخفية — اضغط القائمة لإظهارها',
  'shell.toggleStagesShow': 'إظهار أقسام المشروع',
  'shell.toggleStagesHide': 'إخفاء أقسام المشروع',
  'shell.toggleStagesShowAria': 'إظهار مسار مراحل المشروع',
  'shell.toggleStagesHideAria': 'إخفاء مسار مراحل المشروع',
...
const en: Dict = {
  ...
  'common.logoutConfirmTitle': 'Sign out',
  'common.logoutConfirmBody': 'Do you want to sign out of the system?',
  ...
  'shell.toggleClientNavShow': 'Show client pages menu',
  'shell.toggleClientNavHide': 'Hide client pages menu',
  'shell.toggleClientNavShowAria': 'Show client pages menu',
  'shell.toggleClientNavHideAria': 'Hide client pages menu',
  'shell.clientNavOpen': 'Client pages menu open',
  'shell.clientNavHidden': 'Client pages menu hidden',
  'clientNav.default': 'Client pages',
  'dateFilter.from': 'From date',
  'dateFilter.to': 'To date',
  'dateFilter.clear': 'Clear range',
  ...
  'sales.dashboard.clients': 'Clients in range',
  'sales.dashboard.documents': 'Documents in range',
  'sales.dashboard.quotations': 'Approved quotations',
  'hr.dashboard.employees': 'Total employees',
  'hr.dashboard.active': 'Active employees',
  'hr.dashboard.assignments': 'Linked projects',
  'procurement.dashboard.vendors': 'Vendors',
  'procurement.dashboard.orders': 'Purchase orders',
  'procurement.dashboard.rfqs': 'RFQs',
  'shell.stagesVisible': 'Project stages visible — tap the menu to hide',
  'shell.stagesHidden': 'Project stages hidden — tap the menu to show',
  'shell.toggleStagesShow': 'Show project stages',
  'shell.toggleStagesHide': 'Hide project stages',
  'shell.toggleStagesShowAria': 'Show project stage path',
  'shell.toggleStagesHideAria': 'Hide project stage path',
