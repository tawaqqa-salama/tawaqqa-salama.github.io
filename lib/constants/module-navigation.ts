...
export const DEPARTMENT_SUB_MODULES: Record<DepartmentId, DepartmentSubModule[]> = {
  marketing: [
    ...
    { id: 'leads', label: 'Leads', tab: 'leads' },
    {
      id: 'campaigns',
      label: 'Campaigns',
      description: 'حملات التسويق وواتساب',
      tab: 'campaigns',
    },
    { id: 'whatsapp', label: 'WhatsApp', tab: 'whatsapp' },
    {
      id: 'social',
      label: 'السوشال ميديا',
      description: 'حسابات، صندوق وارد، محتوى، تقويم، تحليلات',
      tab: 'social',
    },
    {
      id: 'website',
      label: 'Website',
      description: 'موقع المكتب والنماذج وربط CRM',
      tab: 'website',
    },
