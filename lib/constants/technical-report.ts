...
export const TECH_REPORT_ITEMS: TechReportItemCatalog[] = [
  {
    ...
    title: 'مضخات الحريق',
    defaultNotes:
      'يتم تصميم واختيار مضخات الحريق وفق الحسابات الهيدروليكية ومتطلبات كود البناء السعودي.',
    optionChoices: [
      'توفير مضخة حريق رئيسية بسعة مناسبة وفق الحساب الهيدروليكي',
      'توفير مضخة احتياطية (Jockey / Standby) حسب الاشتراط',
      'تركيب المضخات في غرفة مخصصة محمية ومعتمدة',
  ...
  },
  {
    ...
    defaultNotes: 'تأمين خزان مياه مكافحة حريق بسعة تغطي مدة التشغيل المطلوبة.',
    optionChoices: [
